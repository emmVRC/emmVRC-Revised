...
namespace emmVRC.Objects
{
    public class Attributes
    {
        ...
        public static int LastTestedBuildNumber = 1016;
        public static string EULAVersion = "1.0.0";
        public static bool Beta = false;
        public static string DateUpdated = "11/20/2020";
        ...
        public static string Changelog =
            "This is an pre-release build! Do not distribute to others\n" +
            "• Added future-proofing for newer versions of VRChat\n" +
            "• Slight optimizations to the Custom Avatar favorites";
