...
namespace emmVRC.Objects
{
    public class Attributes
    {
        ...
        public static int LastTestedBuildNumber = 1106;
        public static string EULAVersion = "1.0.1";
        public static bool Beta = false;
        public static string DateUpdated = "06/16/2021";
        ...
        public static string Changelog =
            "• Added compatibility for VRChat build 1106\n" +
            "• Instance History will now show the region that an\n" +
            "instance was in";
