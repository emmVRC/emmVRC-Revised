    ...
    public static class PopupManagerUtils
    {
        ...
        public static ShowUiStandardPopup1Action ShowUiStandardPopup1
        {
            get
            {
                ...
                var targetMethod = typeof(VRCUiPopupManager).GetMethods(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public)
                    .Single(it => it.GetParameters().Length == 3 && XrefScanner.XrefScan(it).Any(jt => jt.Type == XrefType.Global && jt.ReadAsObject()?.ToString() == "UserInterface/MenuContent/Popups/StandardPopup"));
        ...
        public static ShowUiStandardPopup2Action ShowUiStandardPopup2
        {
            get
            {
                ...
                var targetMethod = typeof(VRCUiPopupManager).GetMethods(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public)
                    .Single(it => it.GetParameters().Length == 5 && XrefScanner.XrefScan(it).Any(jt => jt.Type == XrefType.Global && jt.ReadAsObject()?.ToString() == "UserInterface/MenuContent/Popups/StandardPopup"));
        ...
        public static ShowUiStandardPopup3Action ShowUiStandardPopup3
        {
            get
            {
                ...
                var targetMethod = typeof(VRCUiPopupManager).GetMethods(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public)
                    .Single(it => it.GetParameters().Length == 7 && XrefScanner.XrefScan(it).Any(jt => jt.Type == XrefType.Global && jt.ReadAsObject()?.ToString() == "UserInterface/MenuContent/Popups/StandardPopup"));
        ...
        public static ShowUiStandardPopupV21Action ShowUiStandardPopupV21
        {
            get
            {
                ...
                var targetMethod = typeof(VRCUiPopupManager).GetMethods(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public)
                    .Single(it => it.GetParameters().Length == 5 && XrefScanner.XrefScan(it).Any(jt => jt.Type == XrefType.Global && jt.ReadAsObject()?.ToString() == "UserInterface/MenuContent/Popups/StandardPopupV2"));
        ...
        public static ShowUiStandardPopupV22Action ShowUiStandardPopupV22
        {
            get
            {
                ...
                var targetMethod = typeof(VRCUiPopupManager).GetMethods(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public)
                    .Single(it => it.GetParameters().Length == 7 && XrefScanner.XrefScan(it).Any(jt => jt.Type == XrefType.Global && jt.ReadAsObject()?.ToString() == "UserInterface/MenuContent/Popups/StandardPopupV2"));
        ...
        public static ShowUiAlertPopupAction ShowUiAlertPopup
        {
            get
            {
                ...
                var targetMethod = typeof(VRCUiPopupManager).GetMethods(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public)
                    .Single(it => it.GetParameters().Length == 3 && XrefScanner.XrefScan(it).Any(jt => jt.Type == XrefType.Global && jt.ReadAsObject()?.ToString() == "UserInterface/MenuContent/Popups/AlertPopup"));
