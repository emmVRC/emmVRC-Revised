...
namespace emmVRC.Menus
{
    ...
    public class FunctionsMenuLegacy : MelonLoaderEvents
    {
        ...
        public override void OnUiManagerInit()
        {
            ...
            baseMenu.pageItems.Add(new PageItem("World\nTweaks", () => { WorldTweaksMenuLegacy.baseMenu.Open(); }, "Contains tweaks to affect the world around you"));

            // Add the Player Tweaks button
            baseMenu.pageItems.Add(new PageItem("Player\nTweaks", () => { PlayerTweaksMenuLegacy.baseMenu.Open(); }, "Contains tweaks to affect your movement, as well as the players around you"));

            // Add the Instance History button
            baseMenu.pageItems.Add(new PageItem("Instance\nHistory", () => { InstanceHistoryMenuLegacy.baseMenu.OpenMenu(); InstanceHistoryMenuLegacy.LoadMenu(); }, "Allows you to join an instance you were previously in, so long as you have not been kicked from it"));
            ...
            baseMenu.pageItems.Add(new PageItem("Programs", () => { ProgramMenuLegacy.baseMenu.OpenMenu(); }, "Lets you launch external programs from within VRChat."));

            baseMenu.pageItems.Add(new PageItem("Player\nHistory", () => { PlayerHistoryMenuLegacy.ShowMenu(); }, "Allows you to view players who have entered this instance since you joined"));

            // Add the Settings button
            baseMenu.pageItems.Add(new PageItem("Settings", () => { SettingsMenuLegacy.LoadMenu(); }, "Access the Settings for emmVRC, including Risky Functions, color changes, etc."));
            baseMenu.pageItems.Add(new PageItem("Alarm\nClocks", () => { Menus.AlarmClockMenu.Open(); }, "Configure emmVRC's alarm clocks"));
            for (int i = 0; i <= 3; i++)
            {
