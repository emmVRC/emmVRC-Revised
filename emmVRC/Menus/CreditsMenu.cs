...
namespace emmVRC.Menus
{
    public class CreditsMenu
    {
        ...
        public static void Initialize()
        {
            ...
            baseMenu.pageItems.Add(new PageItem("<color=#E91E63>Xhail</color>", null, "Network developer"));
            ...
            baseMenu.pageItems.Add(new PageItem("<color=#C67228>Riski</color>", null, "Helper in the community"));
