...
namespace emmVRC.Menus
{
    public class ActionMenuFunctions : MelonLoaderEvents, IWithLateUpdate
    {
        ...
        public static IEnumerator Initialize()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                favouriteEmojiButtons.Add(new CustomActionMenu.Button(favouriteEmojisMenu, "", () =>
                {
                    ...
                    VRCPlayer.field_Internal_Static_VRCPlayer_0.SpawnEmoji(Configuration.JSONConfig.FavouritedEmojis[currentEmojiButtonOption]);
                    playingEmoji = true;
        ...
        public void LateUpdate()
        {
            ...
            if (Functions.UI.EmojiFavourites.emojiTextures != null)
            {
                for (int i = 0; i < Configuration.JSONConfig.FavouritedEmojis.Count; i++)
                {
                    favouriteEmojiButtons[i].SetIcon(Functions.UI.EmojiFavourites.emojiTextures[Configuration.JSONConfig.FavouritedEmojis[i]]);
                }
