...
namespace emmVRC.Hacks
{
    public class TabMenu
    {
        ...
        public static IEnumerator Initialize()
        {
            ...
            newTab.transform.Find("Icon").GetComponent<UnityEngine.UI.Image>().sprite = Resources.TabIcon;
            ...
            logoButton = new QMSingleButton(tabMenu, 1, 0, "", () => { System.Diagnostics.Process.Start("https://discord.gg/SpZSH5Z"); }, "emmVRC Version v" + Objects.Attributes.Version + " by the emmVRC Team. Click the logo to join our Discord!", Color.white, Color.white);
            ...
            logoButton.getGameObject().GetComponentInChildren<UnityEngine.UI.Image>().sprite = Resources.onlineSprite;
